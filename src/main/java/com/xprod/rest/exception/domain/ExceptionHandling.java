...
public class ExceptionHandling implements ErrorController{
	    ...
	    public ResponseEntity<HttpResponse>  userNotFoundException(UserNotFoundException exception) {
			 ...
			 * ResponseEntity<HttpResponse> noHandlerFoundException(NoHandlerFoundException
			 * exception) { return createHttpResponse(BAD_REQUEST, "This page not found"); }
			 */
	    ...
	    public ResponseEntity<HttpResponse>notFound404(HttpStatus httpStatus,String message) {
	    	return createHttpResponse(NOT_FOUND,"There is  mapping for this URL ");
